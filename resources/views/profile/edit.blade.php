    ...
    <form method="POST" action="/profile">
        ...
        <div class="field">
            ...
            <div style="display:flex;border:1.5px solid #e5e7eb;border-radius:10px;overflow:hidden;">
                ...
                <input id="phone" name="phone" value="{{ old('phone', auth()->user()->phone) }}" placeholder="901234567" required style="flex:1;border:none;outline:none;padding:10px 14px;font-size:0.9rem;font-family:inherit;">
            </div>
