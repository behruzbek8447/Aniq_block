    ...
    <div class="form-card">
        ...
        <form method="POST" action="/register">
            ...
            <div class="field">
                ...
                <input id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Ismingiz" required autofocus>
            ...
            <div class="field">
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" placeholder="Parolni takrorlang" required>
            </div>
            <button type="submit" class="btn-primary">Ro'yxatdan o'tish</button>
        </form>

        <p class="meta">Mavjud hisobingiz bormi? <a href="/login">Kirish</a></p>
    </div>
</body>
</html>
