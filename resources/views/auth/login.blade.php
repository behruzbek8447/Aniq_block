...
<head>
    ...
    <title>Kirish — Turon odob-ilm maktabi</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .brand h1 { color: #854d0e; font-size: 1.35rem; font-weight: 700; }
        .brand p { color: #6b7280; font-size: 0.85rem; margin-top: 4px; }
        ...
        .btn-login:hover { background: #854d0e; transform: translateY(-1px); }
    ...
    <div class="login-card">
        ...
        <form method="POST" action="/login">
            ...
            <div class="field">
                ...
                <input id="phone" type="tel" name="phone" value="{{ old('phone') }}" placeholder="+998 90 123 45 67" required autofocus>
        ...
        <p class="meta">Hali hisobingiz yo'qmi? <a href="/register">Ro'yxatdan o'tish</a></p>
    </div>
</body>
</html>
